export const CommandList = {
  ...
  TEACHTYPE_SET: 0x2104,
  DRAG_TRAJ_INQUIRE: 0x7501,
  DRAG_PARAM_SET: 0x7504,
  DRAG_PARAM_INQUIRE: 0x7505,
  DRAG_TRAJ_PARAM_SET: 0x7507,
  DRAG_TRAJ_PARAM_INQUIRE: 0x7508,
  DRAG_TRAJ_RECORD_INQUIRE: 0x750a,
  DRAG_TRAJ_PLAYBACK: 0x750c,
  DRAG_TRAJ_SAVE: 0x750d,
  DRAG_TRAJ_DELETE: 0x750e,
};
