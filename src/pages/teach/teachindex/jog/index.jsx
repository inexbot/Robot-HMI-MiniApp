      ...
      <View className="jog-index" style="margin-top:10vh">
        ...
        <View className="jog-index-buttons">
          <View className="jog-index-buttons-single">
            <View
              className="jog-index-buttons-single-button"
              onLongPress={startJog.bind(this, 1, -1)}
          ...
          <View className="jog-index-buttons-single">
            <View
              className="jog-index-buttons-single-button"
              onLongPress={startJog.bind(this, 2, -1)}
              onTouchCancel={stopJog}
              onTouchEnd={stopJog}
            >
              -
          ...
          <View className="jog-index-buttons-single">
            <View
              className="jog-index-buttons-single-button"
              onLongPress={startJog.bind(this, 3, -1)}
              onTouchCancel={stopJog}
              onTouchEnd={stopJog}
            >
              -
          ...
          <View className="jog-index-buttons-single">
            <View
              className="jog-index-buttons-single-button"
              onLongPress={startJog.bind(this, 4, -1)}
              onTouchCancel={stopJog}
              onTouchEnd={stopJog}
            >
              -
          ...
          <View className="jog-index-buttons-single">
            <View
              className="jog-index-buttons-single-button"
              onLongPress={startJog.bind(this, 5, -1)}
              onTouchCancel={stopJog}
              onTouchEnd={stopJog}
            >
              -
          ...
          <View className="jog-index-buttons-single">
            <View
              className="jog-index-buttons-single-button"
              onLongPress={startJog.bind(this, 6, -1)}
              onTouchCancel={stopJog}
              onTouchEnd={stopJog}
            >
              -
